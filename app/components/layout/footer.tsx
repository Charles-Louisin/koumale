      ...
      <div className="max-w-6xl mx-auto px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="flex items-center gap-1">
              <Link href="/" className="flex items-center gap-1">
                ...
                <span className="text-lg md:text-xl font-semibold tracking-tight">KOUMALE</span>
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-4 pt-2">
              <a
                href="#"
                className="w-10 h-10 bg-neutral-200 hover:bg-primary rounded-lg flex items-center justify-center transition-all hover:scale-110"
                aria-label="Facebook"
              >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-neutral-600">
              ...
              <li className="flex items-start">
                ...
                <a href="tel:+237682601458" className="hover:text-primary transition-colors">
                  +237 682601458
                </a>
              </li>
              <li className="flex items-start">
        ...
        <div className="border-t border-neutral-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-neutral-600">
            © {new Date().getFullYear()} KOUMALE. Tous droits réservés.
          </p>
