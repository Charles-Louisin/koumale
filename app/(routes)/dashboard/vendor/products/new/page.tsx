  ...
  React.useEffect(() => {
    const loadCategories = async () => {
      try {
        ...
        toastError('Erreur lors du chargement des catégories');
      } finally {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Ajouter un produit</h1>
            ...
            {price && promotionalPrice && discountPercentage > 0 && (
              <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-xl font-bold text-orange-600">{promotionalPrice} FCFA</span>
