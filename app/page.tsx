  ...
  React.useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const trendingRes = await productsApi.list({ limit: 12, page: 1 });
        if (trendingRes.success && trendingRes.data) {
          ...
          setTrendingProducts(sorted.slice(0, 12));
        }
        ...
        if (popularVendorsRes.success && popularVendorsRes.data) {
          setPopularVendors(popularVendorsRes.data.slice(0, 12));
        }
      } catch (error) {
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 id="promotions-heading" className="text-3xl md:text-4xl font-display font-bold text-gray-800">
                      Promotions Flash
                    </h2>
                    <p className="text-sm text-gray-600">Retrouvez toutes les promotions</p>
                  </div>
                </div>
              </div>
              <Link
                href="/products?promotion=true"
                className="hidden md:inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary to-orange-500 text-white font-semibold rounded-full hover:shadow-lg transition-all hover:-translate-y-1"
              >
                Voir tout
                  ...
                  return (
                    ...
                    >
                      <Link href={`/vendor/${product.vendor?.vendorSlug || ''}/product/${product._id}`}>
                        <Card className={`overflow-hidden bg-white border border-gray-200 hover:border-red-400/30 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer aspect-square ${cardVariants[variantIndex]} ${isCompact ? 'shadow-md' : 'shadow-sm'}`}>
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 id="trending-heading" className="text-3xl md:text-4xl font-display font-bold text-gray-800">
                      Produits Tendance
                    </h2>
              ...
              <Link
                href="/products"
                className="hidden md:inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-full hover:shadow-lg transition-all hover:-translate-y-1"
              >
                Voir tout
                <ArrowRight className="w-4 h-4" />
              </Link>
                      ...
                      <Link href={`/vendor/${product.vendor?.vendorSlug || ''}/product/${product._id}`}>
                        <Card className={`overflow-hidden bg-white border-gray-200 hover:border-purple-400/40 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer aspect-square ${cardVariants[variantIndex]} ${isMinimal ? 'bg-gradient-to-br from-white to-purple-50/30' : ''}`}>
                          <div className="relative bg-gray-50 overflow-hidden w-full h-full">
                            ...
                            />
                            {hasBadge && (
                              <div className={`absolute top-2 left-2 bg-purple-500 text-white px-2 py-1 ${variantIndex === 3 ? 'rounded-full' : 'rounded-lg'} text-xs font-bold shadow-sm flex items-center gap-1 z-10`}>
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 id="new-vendors-heading" className="text-3xl md:text-4xl font-display font-bold text-gray-800">
                      Nouvelles Boutiques
                    </h2>
              ...
              <Link
                href="/vendors"
                className="hidden md:inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold rounded-full hover:shadow-lg transition-all hover:-translate-y-1"
              >
                Voir tout
                <ArrowRight className="w-4 h-4" />
              </Link>
                      ...
                      <Link href={`/vendor/${vendor.vendorSlug}`}>
                        <Card className={`overflow-hidden bg-white border border-gray-200 hover:border-green-400/40 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-2 cursor-pointer ${cardVariants[variantIndex]}`}>
                          <div className="aspect-[4/3] relative bg-gray-50">
                            ...
                            {hasBadge && (
                              <div className={`absolute top-2 right-2 bg-green-500 text-white px-2 py-1 ${variantIndex === 1 ? 'rounded-full' : 'rounded-lg'} text-xs font-bold shadow-sm`}>
                                Nouveau
                              </div>
                            )}
                          </div>
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 id="popular-vendors-heading" className="text-3xl md:text-4xl font-display font-bold text-gray-800">
              ...
              <Link
                href="/vendors"
                className="hidden md:inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-semibold rounded-full hover:shadow-lg transition-all hover:-translate-y-1"
              >
                Voir tout
                <ArrowRight className="w-4 h-4" />
              </Link>
                    ...
                    >
                      <Link href={`/vendor/${vendor.vendorSlug}`}>
                        <Card className={`overflow-hidden bg-white border border-gray-200 hover:border-yellow-400/50 shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 cursor-pointer ${cardVariants[variantIndex]}`}>
                          ...
                          <CardContent className="pt-8 px-3 pb-3">
                            <h3 className={`truncate mb-2 group-hover:text-yellow-700 transition-colors ${variantIndex === 0 ? 'font-bold text-sm' : variantIndex === 3 ? 'font-bold text-sm' : 'font-semibold text-sm'}`}>
                              {vendor.businessName}
                            </h3>
                            <p className={`text-gray-600 line-clamp-2 mb-3 leading-tight ${variantIndex === 3 ? 'text-xs' : 'text-xs'}`}>
                              {vendor.description}
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
                Rejoignez des milliers d&apos;utilisateurs qui font confiance à KOUMALE pour leurs achats et leurs ventes en ligne
              </p>
