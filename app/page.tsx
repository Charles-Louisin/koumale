            ...
            >
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 id="promotions-heading" className={`${windowWidth <= 440 ? 'text-[15px]' : 'text-2xl md:text-4xl'} font-display font-bold text-gray-800`}>
                      Promotions Flash
                    </h2>
                    <p className={`${windowWidth <= 440 ? 'text-[9px]' : 'text-sm'} text-gray-600`}>Retrouvez toutes les promotions</p>
                  </div>
                </div>
              </div>
              <Link
                        ...
                        <Card className={`overflow-hidden bg-white border border-gray-200 hover:border-red-400/30 shadow-lg hover:shadow-sm transition-all duration-300 hover:-translate-y-1 cursor-pointer aspect-square ${cardVariants[variantIndex]} ${isCompact ? 'shadow-md' : 'shadow-sm'}`}>
                          <div className="relative bg-gray-50 overflow-hidden w-full h-full">
                            ...
                            {product.promotionalPrice && product.promotionalPrice > 0 && (
                              <div className={`absolute top-2 right-2 bg-red-500 text-white ${windowWidth <= 440 ? 'px-2 py-1 text-[9px]' : 'px-2 py-1'} ${variantIndex === 3 ? 'rounded-full' : 'rounded-lg'} text-xs font-bold shadow-sm z-10`}>
                            ...
                            <div className={`absolute bottom-0 left-0 right-0 ${windowWidth <= 440 ? 'p-2' : 'p-3'} text-white`}>
                              ...
                              <h3 className={`line-clamp-2 mb-1 leading-tight ${windowWidth <= 440 ? 'text-[9px] font-medium' : 'text-sm font-medium'}`}>
                                {product.name}
                              </h3>
                              {/* Rating Display */}
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex flex-col">
                                  {product.promotionalPrice && product.promotionalPrice > 0 ? (
                                    <>
                                      <span className={`${windowWidth <= 440 ? 'text-xs' : 'text-sm'} font-bold text-white`}>
                                        {product.promotionalPrice.toFixed(0)} FCFA
                                      </span>
                                      <span className={`${windowWidth <= 440 ? 'text-[9px]' : 'text-xs'} text-white/80 line-through`}>
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 id="new-vendors-heading" className={`${windowWidth <= 440 ? 'text-[14px]' : 'text-2xl md:text-4xl'} font-display font-bold text-gray-800`}>
                      Nouvelles Boutiques
                    </h2>
                    <p className={`${windowWidth <= 440 ? 'text-[9px]' : 'text-sm'} text-gray-600`}>Découvrez les derniers arrivants</p>
                  </div>
                </div>
              </div>
              <Link
